...
TEST( ProcShared_KRmalloc_Cntr, CanConstruct )
{
	...
	ipsm::offset_malloc::offset_malloc_impl* p_mem_alloc = nullptr;

	// Act
	ASSERT_NO_THROW( p_mem_alloc = ipsm::offset_malloc::offset_malloc_impl::placement_new( p_mem, reinterpret_cast<void*>( reinterpret_cast<uintptr_t>( p_mem ) + 1024 ) ) );
	...
	// Clean-up
	ipsm::offset_malloc::offset_malloc_impl::unbind( p_mem_alloc );
}
...
TEST( ProcShared_KRmalloc_Cntr, CanBind )
{
	...
	void*                                    p_mem        = reinterpret_cast<void*>( test_buff );
	ipsm::offset_malloc::offset_malloc_impl* p_mem_alloc  = nullptr;
	ipsm::offset_malloc::offset_malloc_impl* p_mem_alloc2 = nullptr;
	ASSERT_NO_THROW( p_mem_alloc = ipsm::offset_malloc::offset_malloc_impl::placement_new( p_mem, reinterpret_cast<void*>( reinterpret_cast<uintptr_t>( p_mem ) + 1024 ) ) );

	// Act
	ASSERT_NO_THROW( p_mem_alloc2 = ipsm::offset_malloc::offset_malloc_impl::bind( reinterpret_cast<ipsm::offset_malloc::offset_malloc_impl*>( p_mem ) ) );
	...
	ipsm::offset_malloc::offset_malloc_impl::unbind( p_mem_alloc2 );
}

TEST( ProcShared_KRmalloc_Cntr, FailConstruct1 )
{
	// Arrange
	unsigned char test_buff[sizeof( ipsm::offset_malloc::offset_malloc_impl ) + 10];
	void*         p_mem = reinterpret_cast<void*>( test_buff );

	// Act
	EXPECT_ANY_THROW( ipsm::offset_malloc::offset_malloc_impl::placement_new( p_mem, reinterpret_cast<void*>( reinterpret_cast<uintptr_t>( p_mem ) + sizeof( ipsm::offset_malloc::offset_malloc_impl ) + 10 ) ) );
...
TEST( ProcShared_KRmalloc_Cntr, FailConstruct2 )
{
	...
	// Act
	EXPECT_ANY_THROW( ipsm::offset_malloc::offset_malloc_impl::placement_new( p_mem, reinterpret_cast<void*>( reinterpret_cast<uintptr_t>( p_mem ) + 10 ) ) );
...
public:
	...
	void SetUp() override
	{
		...
		p_sut_ = ipsm::offset_malloc::offset_malloc_impl::placement_new( reinterpret_cast<void*>( addr ), reinterpret_cast<void*>( reinterpret_cast<uintptr_t>( p_mem_ ) + alloc_mem_size + 16 ) );
	}
	void TearDown() override
	{
		// Clean-up
		ipsm::offset_malloc::offset_malloc_impl::unbind( p_sut_ );
		free( p_mem_ );
	}

	void*                                    p_mem_;
	ipsm::offset_malloc::offset_malloc_impl* p_sut_;
};
...
{
	// Arrange
	void* p_allc_mem = p_sut_->allocate( alloc_mem_size - sizeof( ipsm::offset_malloc::offset_malloc_impl ) - ipsm::offset_malloc::offset_malloc_impl::test_block_header_size() * 10 /* ipsm::offset_malloc::offset_malloc_impl::block::block_header */ );
